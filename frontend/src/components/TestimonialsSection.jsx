      ...
      <div className="px-4 sm:px-8 lg:px-24">
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="mb-12 lg:mb-24">
            <h2 className="font-impact font-black uppercase text-primary-500 leading-none mb-4 lg:mb-8 text-display">
          ...
          <div className="flex flex-col lg:flex-row gap-0">
            <div className="lg:w-1/2 aspect-[4/3] lg:aspect-square relative bg-primary-500">
              <img 
                src="https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://s3-alpha-sig.figma.com/img/3acf/e040/cf45f2a1864032afb9a521595a43738a?Expires=1759104000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=lvwdLiLAbaxywqLv0D0SFRLX7CK9fyV0~YqeqfRuD9OH02QTuc6f2bhDGUdDVAndLbmHGW~igQSf51t59CP2wUuCY~ZalX6wGSNA4NbKuYRJvNnblYpFLWvmPYYAUccw0yrcD~4PFkobsOQRUHAW9Zp03VqIG1dvQHsRVCCBi1eW~GVNlQgmICcdvP67Tfj2l3VWKppYJDNJbuuCPItrZoKBLRJG00lv~LSDbx3QmIpAe~pNSeeZdmcFNqNmgjKC30Kf4gaxcbclaI-JabjlqlOJEpZCJfWNVvwa1VbY9W6wjtn-iNMZ~svtamjfvV5G3S5W~NfO~KTGGtLs1kBoQg__"
            ...
            <div className="lg:w-1/2 bg-primary-50 p-8 lg:p-24 flex flex-col justify-between aspect-[4/3] lg:aspect-square">
              <div className="flex flex-col gap-8 lg:gap-12">
                ...
                <div className="flex flex-col gap-6 lg:gap-8">
                  ...
                  <h3 className="text-heading-sm lg:text-subheading font-inter font-semibold text-primary-500 leading-tight tracking-tighter">
                    The Best Platform for Finding Quality Talent.
                  </h3>
                  <p className="text-large font-inter text-primary-500/60 leading-relaxed">
