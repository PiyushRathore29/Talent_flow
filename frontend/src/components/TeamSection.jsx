  ...
  return (
    <div className="flex-1 min-w-0 max-w-sm">
      ...
      <div className="px-4 lg:px-8 py-8 lg:py-12">
        <div className="mb-6">
          <p className="text-medium font-times italic text-primary-500/60 mb-2">
            ({role})
          </p>
        </div>
        
        <div className="space-y-3">
          <h3 className="font-impact font-black uppercase text-primary-500 leading-tight text-heading-sm whitespace-pre-line">
            {name}
          </h3>
          <p className="text-small font-inter text-primary-500/60 leading-relaxed">
            {description}
          </p>
        </div>
      </div>
