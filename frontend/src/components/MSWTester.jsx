...
import { apiClient, jobsAPI, candidatesAPI, assessmentsAPI } from '../mocks/apiClient';
...
const MSWTester = () => {
  ...
  const TestButton = ({ testName, label, onClick, variant = 'primary' }) => {
    ...
    const getButtonClass = () => {
      ...
      if (variant === 'secondary') return 'bg-gray-500 hover:bg-gray-600 text-white';
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">MSW API Tester</h1>
          <p className="text-gray-600">Test all Mock Service Worker endpoints</p>
        </div>
        ...
        <TestSection title="Candidates API">
          ...
          <TestButton
            ...
            onClick={() => candidatesAPI.update(1, {
              stage: 'screen',
        ...
        <TestSection title="Assessments API">
          ...
          <TestButton
            ...
            onClick={() => assessmentsAPI.submit(1, {
              candidateId: 1,
              responses: {
                'q1': 'a',
