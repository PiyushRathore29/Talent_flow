  ...
  const StatCard = ({ icon: Icon, title, value, subtitle, color = 'teal' }) => (
    <div className="bg-white dark:bg-black rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 hover:shadow-md transition-all duration-200">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-impact font-medium uppercase text-primary-500 dark:text-primary-400 tracking-wide">{title}</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors duration-200">
      ...
      <div className="bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-impact font-semibold uppercase text-primary-500 dark:text-primary-400 leading-tight tracking-wide">Analytics Dashboard</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Overview of your hiring process</p>
          </div>
      ...
      <div className="flex">
        ...
        <div className="w-64 bg-white dark:bg-black border-r border-gray-200 dark:border-gray-800 min-h-screen">
          <nav className="p-4 space-y-2">
            ...
            <Link to="/candidates" className="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
              <Users className="w-4 h-4 mr-3" />
              Candidates
            </Link>
            <Link to="/jobs" className="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
              <Briefcase className="w-4 h-4 mr-3" />
              Jobs
            </Link>
            <Link to="/assessments" className="flex items-center px-3 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {/* Application Trends */}
            <div className="bg-white dark:bg-black rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
              <h3 className="text-lg font-impact font-medium uppercase text-primary-500 dark:text-primary-400 tracking-wide mb-4">Application Trends</h3>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-black rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
              <h3 className="text-lg font-impact font-medium uppercase text-primary-500 dark:text-primary-400 tracking-wide mb-4">Assessment Completion</h3>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
