            ...
            <ul className="space-y-1">
              ...
              <li>
                <button
                  ...
                  className="w-full text-left flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md transition-colors"
                >
                  <ChevronsRight className="w-4 h-4 text-gray-500" /> Move to
                  Next
                </button>
              </li>
            </ul>
  ...
  return (
    <div className="w-72 bg-white rounded-xl shadow-md border border-gray-200 group/stage">
      ...
      <div className="p-4 border-b border-gray-200 flex justify-between items-center">
        <h4 className="font-semibold text-gray-400 uppercase text-xs tracking-wider flex-1">
          {stageName || stage}
        </h4>
      ...
      <Handle
        ...
        className="!w-4 !h-4 !bg-primary-400 !border-2 !border-white cursor-pointer"
      />
    </div>
  );
};
