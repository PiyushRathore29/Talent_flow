...
export const AssessmentPreviewPane = ({
  ...
  return /*#__PURE__*/ _jsxs("div", {
    ...
    children: [
        ...
        children: [
          ...
          /*#__PURE__*/ _jsx(CardContent, {
            ...
            children: /*#__PURE__*/ _jsx("div", {
              ...
              children:
                "This preview shows how the assessment will appear to candidates. Questions will show/hide based on conditional logic as you fill out responses.",
            }),
          }),
        ],
      }),
                ...
                /*#__PURE__*/ _jsxs("div", {
                  ...
                  children: [
                    ...
                    /*#__PURE__*/ _jsx("p", {
                      ...
                      children:
                        "Some questions are hidden based on current responses. Change your answers to see different questions appear.",
                    }),
                  ],
                }),
              ],
      ...
      /*#__PURE__*/ _jsx("div", {
        className:
          "border-2 border-dashed border-muted-foreground/25 rounded-lg p-1",
        children: /*#__PURE__*/ _jsx(AssessmentForm, {
          key: `${assessment.id}-${assessment.sections.length}-${JSON.stringify(
            assessment.sections.map((s) => s.questions.length)
          )}`,
