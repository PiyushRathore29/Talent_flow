...
import { DndContext, closestCorners, useSensors, useSensor, PointerSensor, KeyboardSensor } from "@dnd-kit/core";
...
export const AssessmentBuilder = ({
  ...
  useEffect(() => {
    if (assessmentId) {
      ...
      const newAssessment = {
        id: nanoid(),
        jobId: selectedJobId,
        title: `Assessment for ${selectedJob?.category || selectedJob?.title || 'Job'}`,
        description: `Assessment to evaluate candidates for the ${selectedJob?.category || selectedJob?.title} position.`,
        sections: [],
        createdAt: new Date(),
        updatedAt: new Date()
      };
  ...
  }, [assessmentId, assessments, selectedJobId, jobs, setCurrentAssessment, setAssessmentBuilder]);
  ...
  const handleSectionReorder = event => {
    ...
    if (oldIndex !== newIndex) {
      const reorderedSections = arrayMove(localAssessment.sections, oldIndex, newIndex).map((section, index) => ({
        ...section,
        order: index
      }));
  ...
  const updateSection = (sectionId, updates) => {
    if (!localAssessment) return;
    const updatedSections = localAssessment.sections.map(section => section.id === sectionId ? {
      ...section,
      ...updates
    } : section);
    handleAssessmentChange("sections", updatedSections);
  ...
  const deleteSection = sectionId => {
    if (!localAssessment) return;
    const updatedSections = localAssessment.sections.filter(section => section.id !== sectionId).map((section, index) => ({
      ...section,
      order: index
    }));
    handleAssessmentChange("sections", updatedSections);
            ...
            /*#__PURE__*/_jsxs("div", {
              ...
              children: [
                ...
                /*#__PURE__*/_jsx("p", {
                  ...
                  children: "Select a job position to create an assessment for:"
                })
              ]
            }),
            /*#__PURE__*/_jsx("div", {
              className: "grid gap-4",
              children: jobs.map(job => /*#__PURE__*/_jsxs("div", {
                key: job.id,
                onClick: () => handleJobSelect(job.id),
                className: "p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 cursor-pointer transition-all duration-200 bg-white dark:bg-gray-800/80 hover:bg-blue-50 dark:hover:bg-gray-700/80 hover:shadow-md",
                children: [
                  /*#__PURE__*/_jsx("h3", {
                  ...
                  /*#__PURE__*/_jsxs("div", {
                    ...
                    children: [
                      ...
                      " • ",
                      /*#__PURE__*/_jsx("span", { children: job.location })
                    ]
                  })
                ]
              }))
  ...
  if (!localAssessment) {
    return /*#__PURE__*/_jsx("div", {
      className: "flex items-center justify-center h-64 bg-white dark:bg-[#000319]",
      children: /*#__PURE__*/_jsxs("div", {
  ...
  return /*#__PURE__*/_jsxs("div", {
    className: "h-full flex flex-col bg-gray-50 dark:bg-[#000319]",
    children: [/*#__PURE__*/_jsxs("div", {
      className: "border-b p-6 shadow-sm bg-white dark:bg-[#0d1025] border-gray-200 dark:border-gray-700",
      children: [/*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsxs(Button, {
            ...
            size: "sm",
            onClick: () => navigate("/assessments"),
            className: "mt-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 flex-shrink-0",
            children: [/*#__PURE__*/_jsx(ArrowLeft, {
              className: "h-4 w-4 mr-2"
            }), !assessmentId ? "Cancel Creation" : "Back to Assessments"]
          }), /*#__PURE__*/_jsxs("div", {
            className: "flex-1",
            children: [!assessmentId, /*#__PURE__*/_jsx(Input, {
              value: localAssessment.title,
              onChange: e => handleAssessmentChange("title", e.target.value),
              className: "text-2xl font-bold border-none p-0 h-auto focus-visible:ring-0 bg-transparent placeholder:text-gray-500 text-gray-900 dark:text-white",
              placeholder: !assessmentId ? "Enter assessment title..." : "Assessment Title"
            }), /*#__PURE__*/_jsx(Textarea, {
              value: localAssessment.description,
              onChange: e => handleAssessmentChange("description", e.target.value),
              className: "mt-3 border-none p-0 resize-none focus-visible:ring-0 bg-transparent placeholder:text-gray-500 text-gray-700 dark:text-gray-300",
              placeholder: !assessmentId ? "Describe what this assessment will evaluate..." : "Add a description to help candidates understand this assessment...",
              rows: 2
            })]
          })]
        }), /*#__PURE__*/_jsxs("div", {
          className: "flex items-center gap-3",
          children: [hasUnsavedChanges && /*#__PURE__*/_jsxs(Badge, {
            variant: "outline",
            className: "text-amber-700 dark:text-amber-300 border-amber-300 dark:border-amber-600 bg-amber-50 dark:bg-amber-900 animate-pulse",
            children: [/*#__PURE__*/_jsx("div", {
              className: "w-2 h-2 bg-amber-500 dark:bg-amber-400 rounded-full mr-2"
            }), "Unsaved Changes"]
        ...
        children: /*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [localAssessment.sections.length, " section", localAssessment.sections.length !== 1 ? "s" : ""]
            })]
          }), /*#__PURE__*/_jsxs("div", {
            className: "flex items-center gap-2",
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: [localAssessment.sections.reduce((total, section) => total + section.questions.length, 0), " ", "questions"]
            })]
          }), /*#__PURE__*/_jsxs("div", {
            className: "flex items-center gap-2",
            children: [/*#__PURE__*/_jsx("div", {
              ...
              children: ["~", localAssessment.sections.reduce((total, section) => total + section.questions.length, 0) * 2, " ", "min duration"]
            })]
          })]
        })
      })]
      ...
      children: /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("div", {
          className: "w-1/4 border-r border-gray-700 overflow-y-auto bg-white dark:bg-[#0d1025]",
          children: /*#__PURE__*/_jsxs("div", {
            className: "p-6",
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsx("h3", {
                ...
                size: "sm",
                onClick: addSection,
                className: "bg-sky-100 dark:bg-blue-900/20 border border-sky-300 dark:border-blue-500/30 text-sky-700 dark:text-blue-400 hover:bg-sky-200 dark:hover:bg-blue-800/30 hover:border-sky-400 dark:hover:border-blue-400 transition-all duration-200",
              ...
              children: /*#__PURE__*/_jsx(SortableContext, {
                ...
                children: /*#__PURE__*/_jsx("div", {
                  className: "space-y-2",
                  children: localAssessment.sections.map(section => /*#__PURE__*/_jsx(SectionManager, {
                    section: section,
                    isSelected: assessmentBuilder.selectedSection === section.id,
                    onSelect: () => setAssessmentBuilder({
            ...
            }), localAssessment.sections.length === 0 && /*#__PURE__*/_jsxs("div", {
              className: "text-center py-12 px-6 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-xl shadow-sm",
              children: [/*#__PURE__*/_jsx("div", {
                ...
                children: "Create your first section to start building your assessment"
              }), /*#__PURE__*/_jsxs(Button, {
                onClick: addSection,
          ...
          className: "w-2/5 border-r border-gray-700 overflow-y-auto bg-white dark:bg-[#000319]",
          children: assessmentBuilder.selectedSection ? (() => {
            const selectedSection = localAssessment.sections.find(s => s.id === assessmentBuilder.selectedSection);
            ...
            return /*#__PURE__*/_jsx("div", {
              ...
              children: /*#__PURE__*/_jsx(QuestionEditor, {
                ...
                onQuestionDelete: questionId => {
                  const updatedSections = localAssessment.sections.map(section => {
                    if (section.id === selectedSection.id) {
                      return {
                        ...section,
                        questions: section.questions.filter(q => q.id !== questionId).map((q, index) => ({
                          ...q,
                          order: index
                        }))
                      };
                  ...
                  handleAssessmentChange("sections", updatedSections);
                  if (assessmentBuilder.selectedQuestion === questionId) {
                    setAssessmentBuilder({
                      selectedQuestion: null
                    });
                  }
                ...
                onQuestionReorder: (fromIndex, toIndex) => {
                  const updatedSections = localAssessment.sections.map(section => {
                    if (section.id === selectedSection.id) {
                      const reorderedQuestions = arrayMove(section.questions, fromIndex, toIndex).map((q, index) => ({
                        ...q,
                        order: index
                      }));
                      return {
            ...
            className: "flex items-center justify-center h-full bg-gray-50 dark:bg-[#000319]",
            children: /*#__PURE__*/_jsxs("div", {
              ...
              children: [/*#__PURE__*/_jsx("div", {
                ...
                className: "text-gray-600 dark:text-gray-400 mb-4",
                children: "Choose a section from the left panel to add and edit questions"
              }), localAssessment.sections.length === 0 && /*#__PURE__*/_jsxs(Button, {
                onClick: addSection,
                className: "bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white transition-colors",
                children: [/*#__PURE__*/_jsx(Plus, {
                  className: "w-4 h-4 mr-2"
